...
<section class="ftco-section-2">
     <div class="container-fluid">
          <div class="section-2-blocks-wrapper d-flex row no-gutters">
               <div class="img col-md-6 ftco-animate" style="background-image: url('{{ env('APP_URL') }}/assets/images/thinking.jpg');" alt="{{ $shopMainTitle }}-{{ $mainGoalAlt }}" title="{{ $shopMainTitle }}-{{ $mainGoalAlt }}">
               </div>
...
<section class="ftco-section-2">
     <div class="container-fluid">
          <div class="section-2-blocks-wrapper d-flex row no-gutters">
               ...
               <div class="img col-md-6 ftco-animate" style="background-image: url('{{ env('APP_URL') }}/assets/images/story.jpg');" alt="{{ $shopMainTitle }}-{{ $mainHistoryAlt }}" title="{{ $shopMainTitle }}-{{ $mainHistoryAlt }}">
               </div>
          </div>
     </div>
</section>
